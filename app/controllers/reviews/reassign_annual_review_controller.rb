module Reviews
  class ReassignAnnualReviewController < BaseController
    ...
    steps :assign, :select_from_another, :add_sba_note, :review, :assignment_confirmation

    def show
      case step
        when :assign
          duty_station_name = current_user.duty_station.name if current_user.duty_station
          @users_within_ds = User.filter_by_duty_stations_and_roles([duty_station_name], ['sba_supervisor_8a_district_office', 'sba_analyst_8a_district_office', 'sba_director_8a_district_office', 'sba_deputy_director_8a_district_office']) if duty_station_name
        ...
        when :review, :assignment_confirmation
