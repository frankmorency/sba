class Reload8aBusinessPartnerQuestionnaire < ActiveRecord::Migration
  def change

    
    Questionnaire.get('eight_a_business_partner').destroy

    CertificateType.create!(name: 'eight_a_business_partner', title: '8(a) Business Partner')
    business_partner = Questionnaire::SubQuestionnaire.create! name: 'eight_a_business_partner', title: '8(a) Business Partner', anonymous: false, program: Program.get('eight_a'), certificate_type: CertificateType.get('eight_a_business_partner'), review_page_display_title: '8(a) Business Partner'
