class Reload8aDvdQuestionnaire < ActiveRecord::Migration
  def change

    
    Questionnaire.get('eight_a_disadvantaged_individual').destroy

    CertificateType.create!(name: 'eight_a_disadvantaged_individual', title: '8(a) Disadvantaged Individual')
    ...
    dvd.create_sections! do
      root 'eight_a_disadvantaged_individual', 1, title: 'DVD' do
        question_section 'general_information', 0, title: 'General Information' do
          ...
          question_section 'us_citizenship', 8, title: 'U.S. Citizenship' do
            yesno_with_attachment_optional_on_yes 'eight_a_us_citizenship', 1, title: 'Are you a U.S. Citizen?'
          end
        end
