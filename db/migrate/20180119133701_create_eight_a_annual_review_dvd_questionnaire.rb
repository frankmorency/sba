class CreateEightAAnnualReviewDvdQuestionnaire < ActiveRecord::Migration
  def change
    dvd = Questionnaire::SubQuestionnaire.create! name: 'eight_a_disadvantaged_individual_annual_review', title: 'Person Claiming Disadvantage for 8(a)', anonymous: false, program: Program.get('eight_a'), review_page_display_title: 'Person Claiming Disadvantage for 8(a)'

    dvd.create_sections! do
      root 'eight_a_disadvantaged_individual_annual_review', 1, title: 'DVD' do
        question_section 'general_information', 0, title: 'General Information' do
          question_section 'gender', 0, title: 'Gender', first: true do
            picklist 'gender', 1, title: 'Gender', possible_values: ['Male', 'Female']
          end
          ...
          question_section 'date_and_place_of_birth', 7, title: 'Date and Place of Birth' do
            ...
            picklist 'country_of_birth', 3, title: 'Country of Birth:', possible_values: Country.pluck(:name).uniq
          end
    ...
    Section.where(questionnaire_id: Questionnaire.get('eight_a_disadvantaged_individual_annual_review').id, name: 'signature').update_all is_last: true
    ...
    #section = eight_a.sections.select{|s| s.name == 'eight_a_disadvantaged_individual_annual_review'}.first
