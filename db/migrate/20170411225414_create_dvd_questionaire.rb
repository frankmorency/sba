class CreateDvdQuestionaire < ActiveRecord::Migration
  def change

      
      Questionnaire.get('eight_a_disadvantaged_individual').destroy
        ...
        root 'eight_a_disadvantaged_individual', 1, title: 'DVD' do
          ...
          question_section 'social_disadvantage', 5, title: 'Basis of Disadvantage' do
            question_section 'eight_a_basis_of_disadvantage', 0, title: "Basis of Disadvantage." do
              picklist_with_comment_required 'eight_a_basis_of_disadvantage', 0, title: 'Select one of the following “presumed disadvantaged groups” as the basis of your social disadvantage.', possible_values: ["Black American", 'Hispanic American', 'Native American', 'Asian Pacific American', 'Subcontinent Asian American', 'None of the above']
            end
            ...
            question_section 'other_basis_of_disadvantage', 2, title: 'Other Basis of Disadvantage' do
              picklist 'eight_a_basis_of_disadvantage', 0, title: 'Please identify the specific feature in the comment field, for example if you selected “Physical Handicap” you might write “Visually Impaired” in the comment field.', possible_values: ['Race', 'Religion', 'Ethnic Origin', 'Gender', 'Sexual Orientation', 'Physical Handicap', 'Long term residence in an environment isolated from mainstream of American society', 'Other']
            end
      ...
      dvd.create_rules! do
        ...
        section_rule 'native_american_documentation', 'social_narrative'
        ...
        section_rule 'eight_a_basis_of_disadvantage', 'social_narrative'
        section_rule 'social_narrative', 'transfer_assets'
        section_rule 'transfer_assets', 'tax_returns'
        section_rule 'tax_returns', 'form413'
        section_rule 'form413', 'review'
      end

      # Setting up Document Types
      q = Question.find_by(name: 'eight_a_us_citizenship')
      DocumentTypeQuestion.create! question_id: q.id, document_type_id: DocumentType.find_by_name("Unexpired passports").id
      DocumentTypeQuestion.create! question_id: q.id, document_type_id: DocumentType.find_by_name("Naturalization papers").id
      DocumentTypeQuestion.create! question_id: q.id, document_type_id: DocumentType.find_by_name("CRBA").id
      ...
      q = Question.find_by(name: 'eight_a_full_time_devotion')
      DocumentTypeQuestion.create! question_id: q.id, document_type_id: DocumentType.find_by_name("External Job Details").id
      q = Question.find_by(name: 'eight_a_business_affiliations')
      DocumentTypeQuestion.create! question_id: q.id, document_type_id: DocumentType.find_by_name("External Business").id
      q = Question.find_by(name: 'eight_a_eligibility_q0')
      DocumentTypeQuestion.create! question_id: q.id, document_type_id: DocumentType.find_by_name("Prior 8(a) involvement").id
      q = Question.find_by(name: 'eight_a_eligibility_q2')
      DocumentTypeQuestion.create! question_id: q.id, document_type_id: DocumentType.find_by_name("Prior 8(a) involvement").id
      q = Question.find_by(name: 'eight_a_federal_employment_q0')
      DocumentTypeQuestion.create! question_id: q.id, document_type_id: DocumentType.find_by_name("Letter of No Objection").id
      q = Question.find_by(name: 'eight_a_household_federal_employment_q0')
      DocumentTypeQuestion.create! question_id: q.id, document_type_id: DocumentType.find_by_name("Letter of No Objection").id
      q = Question.find_by(name: 'eight_a_financial_q0')
      DocumentTypeQuestion.create! question_id: q.id, document_type_id: DocumentType.find_by_name("Bankruptcy Court Final Order").id
      DocumentTypeQuestion.create! question_id: q.id, document_type_id: DocumentType.find_by_name("Bankruptcy Court Discharge").id
      DocumentTypeQuestion.create! question_id: q.id, document_type_id: DocumentType.find_by_name("Bankruptcy explaination").id
      DocumentTypeQuestion.create! question_id: q.id, document_type_id: DocumentType.find_by_name("Other Bankruptcy").id
      q = Question.find_by(name: 'eight_a_financial_q1')
      DocumentTypeQuestion.create! question_id: q.id, document_type_id: DocumentType.find_by_name("SBA loan details").id
      q = Question.find_by(name: 'eight_a_financial_q2')
      DocumentTypeQuestion.create! question_id: q.id, document_type_id: DocumentType.find_by_name("Pending lawsuit details").id
      q = Question.find_by(name: 'eight_a_financial_q3')
      DocumentTypeQuestion.create! question_id: q.id, document_type_id: DocumentType.find_by_name("Debt obligations").id
      q = Question.find_by(name: 'eight_a_criminal_history_q0')
      ...
      q = Question.find_by(name: 'eight_a_criminal_history_q1')
      DocumentTypeQuestion.create! question_id: q.id, document_type_id: DocumentType.find_by_name("Criminal court record").id
      q = Question.find_by(name: 'eight_a_criminal_history_q2')
      DocumentTypeQuestion.create! question_id: q.id, document_type_id: DocumentType.find_by_name("Form FD-258 Fingerprint Card").id
      q = Question.find_by(name: 'eight_a_native_doc')
      DocumentTypeQuestion.create! question_id: q.id, document_type_id: DocumentType.find_by_name("Native American Entity Documentation").id
      q = Question.find_by(name: 'eight_a_social_narative')
      DocumentTypeQuestion.create! question_id: q.id, document_type_id: DocumentType.find_by_name("Discriminatory Narrative").id
      q = Question.find_by(name: 'eight_a_tax_ret')
      DocumentTypeQuestion.create! question_id: q.id, document_type_id: DocumentType.find_by_name("W2").id
      DocumentTypeQuestion.create! question_id: q.id, document_type_id: DocumentType.find_by_name("1099").id
      ...
      DocumentTypeQuestion.create! question_id: q.id, document_type_id: DocumentType.find_by_name("1040").id
      DocumentTypeQuestion.create! question_id: q.id, document_type_id: DocumentType.find_by_name("4506-T").id
      DocumentTypeQuestion.create! question_id: q.id, document_type_id: DocumentType.find_by_name("Other Tax Document").id

      q = Question.find_by(name: 'eight_a_marital_status')
      DocumentTypeQuestion.create! question_id: q.id, document_type_id: DocumentType.find_by_name("Separation agreement from spouse").id
