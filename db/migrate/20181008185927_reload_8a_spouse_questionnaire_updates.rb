class Reload8aSpouseQuestionnaireUpdates < ActiveRecord::Migration
  def change
    Questionnaire.get('eight_a_spouse').update_attribute :name, 'eight_a_spouse_v_two'
    ...
    spouse.create_rules! do
      ...
      section_rule 'eight_a_spouse_criminal_history', 'eight_a_spouse_tax_returns',[
          ...
          {klass: 'Answer', identifier: 'eight_a_criminal_history_q1', value: 'no'},
          {klass: 'Answer', identifier: 'eight_a_criminal_history_q2', value: 'no'},
          {klass: 'Answer', identifier: 'eight_a_criminal_history_q3', value: 'no'}
      ]
    ...
    SectionRule.where(to_section_id: Questionnaire.get('eight_a_spouse').sections.where(name: 'review').pluck(:id)).each do |rule|
    ...
    section = eight_a.sections.select{|s| s.name == 'eight_a_spouse'}.first
    section.sub_questionnaire = spouse
    section.save!
  end
end
