class CreateBusinessPartnerQuestionnaire < ActiveRecord::Migration
  def change

    
    Questionnaire.get('eight_a_business_partner').destroy
    ...
    business_partner.create_sections! do
      ...
      root 'eight_a_business_partner', 1, title: '8(a) Business Partner' do
        question_section 'eight_a_business_partner_general_information', 1, title: 'General Information', submit_text: 'Save and continue' do
          ...
          question_section 'eight_a_business_partner_us_citizenship', 9, title: 'US Citizenship' do
    ...
    q = Question.find_by(name: 'former_majority_owner')
    DocumentTypeQuestion.create! question_id: q.id, document_type_id: DocumentType.find_by_name("Operating agreement").id
    DocumentTypeQuestion.create! question_id: q.id, document_type_id: DocumentType.find_by_name("Articles of organization").id
    ...
    q = Question.find_by(name: 'criminal_history_doc_q0')
    ...
    q = Question.find_by(name: 'criminal_history_doc_q1')
    DocumentTypeQuestion.create! question_id: q.id, document_type_id: DocumentType.find_by_name("Criminal court record").id

    q = Question.find_by(name: 'criminal_history_doc_q2')
