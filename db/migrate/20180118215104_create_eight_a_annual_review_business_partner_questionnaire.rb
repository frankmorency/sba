class CreateEightAAnnualReviewBusinessPartnerQuestionnaire < ActiveRecord::Migration
  def change
    business_partner = Questionnaire::SubQuestionnaire.create! name: 'eight_a_business_partner_annual_review', title: '8(a) Business Partner', anonymous: false, program: Program.get('eight_a'), review_page_display_title: '8(a) Business Partner'

    business_partner.create_sections! do
      root 'eight_a_business_partner_annual_review', 1, title: '8(a) Business Partner' do
    ...
    Section.where(questionnaire_id: Questionnaire.get('eight_a_business_partner_annual_review').id, name: 'signature').update_all is_last: true
