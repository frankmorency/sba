class CreateEightAAnnualReviewSpouseQuestionnaire < ActiveRecord::Migration
  def change
    Questionnaire.transaction do
      spouse = Questionnaire::SubQuestionnaire.create! name: 'eight_a_spouse_annual_review', title: '8(a) Spouse', anonymous: false, program: Program.get('eight_a'), certificate_type: CertificateType.get('eight_a_spouse'), review_page_display_title: '8(a) Spouse'

      spouse.create_sections! do
        root 'eight_a_spouse_annual_review', 1, title: '8(a) Spouse' do
    ...
    Section.where(questionnaire_id: Questionnaire.get('eight_a_spouse_annual_review').id, name: 'signature').update_all is_last: true
