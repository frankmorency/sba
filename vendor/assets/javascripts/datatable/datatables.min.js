 ...
 *   https://datatables.net/download/#dt/dt-1.10.10,af-2.1.0,b-1.1.0,b-colvis-1.1.0,b-print-1.1.0,cr-1.3.0,kt-2.1.0,r-2.0.0,se-1.1.0
 *
 * Included libraries:
 *   DataTables 1.10.10, AutoFill 2.1.0, Buttons 1.1.0, Column visibility 1.1.0, Print view 1.1.0, ColReorder 1.3.0, KeyTable 2.1.0, Responsive 2.0.0, Select 1.1.0
 */
...
m.ext=s={buttons:{},classes:{},build:"dt/dt-1.10.10,af-2.1.0,b-1.1.0,b-colvis-1.1.0,b-print-1.1.0,cr-1.3.0,kt-2.1.0,r-2.0.0,se-1.1.0",errMode:"alert",feature:[],search:[],selector:{cell:[],column:[],row:[]},internal:{},legacy:{ajax:null},pager:{},renderer:{pageButton:{},header:{}},order:{},type:{detect:[],search:{},order:{}},_unique:0,fnVersionCheck:m.fnVersionCheck,iApiIndex:0,oJUIClasses:{},sVersion:m.version};h.extend(s,{afnFiltering:s.search,aTypes:s.type.detect,ofnSearch:s.type.search,oSort:s.type.order,afnSortData:s.order,aoFeatures:s.feature,oApi:s.internal,oStdClasses:s.classes,
