...
(function(window, $, undefined) {
    ...
    Grid.prototype = {
        ...
        _createCell: function(item, field) {
            ...
            var itemIndex = this._itemIndex(item);

            var args = { value: fieldValue, item : item, itemIndex: itemIndex };
            if($.isFunction(field.cellRenderer)) {
                $result = this.renderTemplate(field.cellRenderer, field, args).append('<p>'+this.renderTemplate(field.itemTemplate || fieldValue, field, args));
            } else {
